...
<td colspan="3">
    ...
    <div id="month-calendar">
        ...
        <ul class="month">
            <li wire:click="prevv('{{$carbonDate->locale('fr')}}')" :wire:key="now().$carbonDate" class="prev"><i class="fas fa-angle-double-left"></i></li>
            <li wire:click="nextt('{{$carbonDate->locale('fr')}}')" :wire:key="now().$carbonDate" class="next"><i class="fas fa-angle-double-right"></i></li>
        ...
        <ul class="days">
            ...
            <div>
                <livewire:groups.calendar.list-repas-for-day :day="$carbonDate" :wire:key="$i.now().$carbonDate"/>
                <livewire:groups.calendar.data-for-day :day="$carbonDate" :wire:key="$i.now().$carbonDate"/>
